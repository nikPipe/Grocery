...
from ui_OldOne.widget import midWidget_MealWidget
from ui_OldOne.widget import midWidget_recepieWidget
from ui_OldOne.widget import midWidget_shoppingWidget
