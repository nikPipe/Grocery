...
class commonAllSearch_Widget(QWidget):
    def __init__(self, parent):
        ...
        self.allMealList = self.mainWidget.mealDic
    ...
    def mealViewWidget_update(self, lineedit):
        ...
        for each in self.allMealList:
            name = self.allMealList[each]['name']
            if text.lower() in name.lower():
                mealList.append(self.allMealList[each])
        try:
        ...
        if text == '':
            ...
            self.parent.homeWidgetMain_lineEdit.setText('')
