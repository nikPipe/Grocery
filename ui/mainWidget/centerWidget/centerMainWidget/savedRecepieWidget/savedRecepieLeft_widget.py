...
class savedRecepieLeft_widget(QWidget):
    ...
    def name_button(self):
        ...
        label = self.sample_widget.label(set_text='Saved Recepie', set_object_name=label_objectName, set_styleSheet=styleSheet_,
