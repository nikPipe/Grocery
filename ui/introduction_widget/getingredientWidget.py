...
class getingredientWidget(QWidget):
    ...
    def initUI(self):
        ...
        ingredientLabel = commonButton.label_def(objName='ingredientLabel',
                                                color=self.color_class.white_color.get_value(),
                                                val=20,
                                                name='Any Ingredient you don\'t like?')
        gridLayout.addWidget(ingredientLabel, 1, 0, 1, 1)
        ...
        appName = self.sample_widget.label(set_object_name=appName_object,
                                                    ...
                                                    set_text='Any Ingredient you don\'t like?', set_alighment=self.sample_widget.center_alignment)
    ...
    def allergyWidget(self):
        ...
        get_allergies = self.help_class.getingredientNotInclude()
        a = 0
        color = self.color_class.setColorVal(r=141, g=141, b=141)
        for each in get_allergies:
            ...
            self.allIngredientList.append(pushButton)
    ...
    def setValue(self):
        ...
        '''
        allIngredientList = []
        for each in self.allIngredientList:
            if each.isChecked():
                allIngredientList.append(each.text())

        self.parent.userData['IngredientListNotLike'] = allIngredientList
        self.parent.set_stakeWidget_def(5)
