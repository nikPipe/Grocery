...
from ui_old.sampleWidget import styleSheet, commonProperty
...
class SAMPLE_WIDGET_TEMPLATE():
    ...
    def pushButton(self, parent_self='', min_size=[0, 0], max_size=[16777215, 16777215], set_text='', set_object_name='',
    ...
    def list_widget(self, addItems=[]):
        ...
        listWidget.setSelectionMode(listWidget.ExtendedSelection)
